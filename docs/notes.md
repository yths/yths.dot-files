...
The detailed palette table (visual swatches plus sRGB values for every token in both modes) is co-located with the swatch PNGs at [../assets/themes/nuunamnir/palette/README.md](../assets/themes/nuunamnir/palette/README.md). The full philosophical derivation is at [nuunamnir.color-scheme](https://www.github.com/nuunamnir/nuunamnir.color-scheme).
